...
md:
  ...
  source_link: false         # append "Source: <url>" pointing back at the HTML page, default false
...
md_source_link: true    # override the site-wide source_link setting for this page only
---
```
